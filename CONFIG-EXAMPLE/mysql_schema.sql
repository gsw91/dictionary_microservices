...
CREATE TABLE `dict_conf` (
  ...
  `dict_name` varchar(100) COLLATE utf8_polish_ci NOT NULL,
  `dict_description` varchar(255) COLLATE utf8_polish_ci DEFAULT NULL,
...
CREATE TABLE `dict_item` (
  ...
  CONSTRAINT `fx_id_dict_conf` FOREIGN KEY (`id_dict_conf`) REFERENCES `dict_conf` (`id`),
...
-- Dump completed on 2020-12-12  0:13:26
